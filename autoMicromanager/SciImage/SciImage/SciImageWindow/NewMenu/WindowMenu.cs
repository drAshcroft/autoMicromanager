...
namespace SciImage.Menus
{
        ...
        : PdnMenuItem
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Windows";// PdnResources.GetString("Menu.Window.Text");
            // 
        ...
        {
             this.AppWorkspace.RequestFormShow(this.AppWorkspace.RequestFormCreation(AppWorkspace.Widgets.ToolsForm ));
           /* tf.ToolsFormControl1.ForceResize();
            tf.ToolsFormControl1.Visible = true;
            tf.ToolsFormControl1.ToolsControl.Visible = true;
            tf.ToolsFormControl1.ToolsControl.ForceVisible();
...
//            ToggleFormVisibility(AppWorkspace.Widgets.ToolsForm);
        ...
        private void MenuWindowHistory_Click(object sender, System.EventArgs e)
        {
            ...
            this.AppWorkspace.RequestFormShow(this.AppWorkspace.RequestFormCreation( AppWorkspace.Widgets.HistoryForm));
        ...
        private void MenuWindowLayers_Click(object sender, System.EventArgs e)
        {
            ...
            this.AppWorkspace.RequestFormShow(this.AppWorkspace.RequestFormCreation(AppWorkspace.Widgets.LayerForm));
        ...
        private void MenuWindowColors_Click(object sender, System.EventArgs e)
        {
            ...
            AppWorkspace.RequestFormShow(this.AppWorkspace.RequestFormCreation(AppWorkspace.Widgets.ColorsForm));
