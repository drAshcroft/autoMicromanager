...
namespace SciImage
{
          ...
          IInkHooks
    {
        ...
        protected void RenderCompositionTo(Surface dst, bool highQuality, bool forceUpToDate)
        {
            ...
            {
                Surface thumb = new Surface(dst.Size,new ColorBgra () );
        ...
        private void InitRenderSurface(ColorPixelBase Requiredformat)
        {
            if (this.compositionSurface == null && Document != null)
            {
                this.compositionSurface = new Surface(Document.Size,Requiredformat );
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            InitRenderSurface(new ColorBgra());
        ...
        private void DocumentSetImpl(Document value)
        {
            ...
            try
            {
                ...
                if (document != null)
                {
                    ...
                    if (this.compositionSurface == null)
                    {
                        this.compositionSurface = new Surface(Document.Size,new ColorBgra());
                    }
        ...
        private void InitializeComponent()
        {
            ...
            this.topRuler = new SciImage.Ruler();
            this.leftRuler = new SciImage.Ruler();
            this.panel = new SciImage.PanelEx();
            this.surfaceBox = new SciImage.SurfaceBox();
            ...
            this.surfaceBox.PrePaint += new SciImage.PaintEventHandler2(this.SurfaceBox_PrePaint);
            // 
            // DocumentView
            // 
