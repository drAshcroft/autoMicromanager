...
namespace SciImage.Data.Quantize
{
    public unsafe abstract class Quantizer
    {
                ...
                for (int row = 0; row < height; row++)
                {
                    ...
                    for (int col = 0; col < width; ++col)
                    {
                        ...
                        *pDestinationPixel = pixelValue;
                        ...
                        ColorBgra actual = ColorBgra.sFromColor(pallete[pixelValue]);
        ...
        /// </remarks>
        protected virtual void InitialQuantizePixel(ColorPixelBase pixel)
        {
        }
        ...
        protected abstract byte QuantizePixel(ColorPixelBase pixel);
