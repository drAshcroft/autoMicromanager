...
namespace SciImage.Actions
{
        ...
        : SciImage.Actions.PluginAction
    {
            ...
            int tileCount, Procedure progressCallback, ref bool pleaseStopMonitor)
        {
            ...
            surface.Clear(surface.ColorPixelBase.FromBgra(255, 255, 255, 0));

            SciImage.Threading.ThreadPool threadPool = new SciImage.Threading.ThreadPool();
            int rectCount;
            ...
            : CallbackWithProgressDialog
        {
            ...
            private void ResizeDocument()
            {
                ...
                // This is only sort of a hack: we must try and allocate enough for 2 extra blayer-sized buffers
                ...
                try
                {
                    ...
                    {
                        s1 = new Surface(this.newSize,layer.Surface.ColorPixelBase );
                        s2 = new Surface(this.newSize, layer.Surface.ColorPixelBase);
                        if (this.pleaseStop)
                        {
        ...
        public override bool PerformAction(AppWorkspace appWorkspace, List<HistoryMemento> OptionalHistoryRecord, int TargetLayerIndex)
        {
            ...
            if (OptionalHistoryRecord == null)
                documentWorkspace.History.PushNewMemento(ha);
            else
