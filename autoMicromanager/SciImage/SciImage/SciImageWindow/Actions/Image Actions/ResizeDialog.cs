...
namespace SciImage
{
        ...
        : PdnBaseForm
    {
        ...
        protected SciImage.HeaderLabel resizedImageHeader;
        protected System.Windows.Forms.Label resolutionLabel;
        protected SciImage.UnitsComboBox unitsComboBox2;
        protected SciImage.UnitsComboBox unitsComboBox1;
        ...
        protected SciImage.HeaderLabel pixelSizeHeader;
        protected SciImage.HeaderLabel printSizeHeader;
        ...
        {
            long bytes = unchecked((long)layers * (long)4 * (long)constrainer.NewPixelWidth * (long)constrainer.NewPixelHeight);
            string bytesText = Utility.SizeStringFromBytes(bytes);
            string textFormat = "New size: {0} in bytes";
        ...
        public ResizeDialog()
        {
            ...
            this.pixelSizeHeader.Text = "Pixel Area";
            this.printSizeHeader.Text = "Print Area";
            this.pixelsLabel1.Text = "pixels";
            this.pixelsLabel2.Text = "pixels";
            this.resolutionLabel.Text = "New Resolution";
            this.percentRB.Text = "Change by  percent:";
            this.absoluteRB.Text = "Change by original size:";
            this.resamplingLabel.Text = "Resampling Method:";
            this.cancelButton.Text = "Cancel";
            this.okButton.Text = "OK";
            this.newWidthLabel1.Text = "Width:";
            this.newHeightLabel1.Text = "Height:";
            this.newWidthLabel2.Text = "Width:";
            this.newHeightLabel2.Text = "Height:";
            this.constrainCheckBox.Text = "&Constrain aspect";
        ...
        private void InitializeComponent()
        {
            ...
            this.resizedImageHeader = new SciImage.HeaderLabel();
            ...
            this.unitsComboBox2 = new SciImage.UnitsComboBox();
            this.unitsComboBox1 = new SciImage.UnitsComboBox();
            ...
            this.pixelSizeHeader = new SciImage.HeaderLabel();
            this.printSizeHeader = new SciImage.HeaderLabel();
            ...
            this.unitsComboBox2.Units = SciImage.MeasurementUnit.Inch;
            this.unitsComboBox2.UnitsDisplayType = SciImage.UnitsDisplayType.Ratio;
            ...
            this.unitsComboBox1.Units = SciImage.MeasurementUnit.Inch;
        ...
        private void PopulateAsteriskLabels()
        {
            ...
            switch (rm.method)
            {
                ...
                case ResamplingAlgorithm.SuperSampling:
                    ...
                    {
                        this.asteriskTextLabel.Text = "* Best quality is selected";
                    }
                    else
                    {
                        this.asteriskTextLabel.Text = "* Bicubic is standard";
                    }
