...
namespace SciImage
{
        ...
        : PdnBaseForm
    {
        ...
        {
            this.documentStrip = new SciImage.DocumentStrip();
            this.documentListHeader = new SciImage.HeaderLabel();
            this.hScrollBar = new System.Windows.Forms.HScrollBar();
            this.saveButton = new SciImage.CommandButton();
            this.dontSaveButton = new SciImage.CommandButton();
            this.cancelButton = new SciImage.CommandButton();
