...
namespace SciImage
{
    public static class PdnResources
    {
        ...
        private const string ourNamespace = "SciImage.PDNResources";
        ...
        {
            const string left = "SciImage.Strings.3";
        ...
        {
            const string stringsFileName = "SciImage.Strings.3";
        ...
        public static Stream GetResourceStream(string fileName)
        {
            ...
            if (stream == null)
            {
                ...
                string [] names= ourAssembly.GetManifestResourceNames();
            }
        ...
        {
            System.Diagnostics.Debug.Print("2- " + fileName);
