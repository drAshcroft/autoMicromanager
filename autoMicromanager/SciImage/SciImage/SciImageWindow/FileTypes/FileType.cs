...
{
    /// <summary>
    /// Represents one type of file that SciImage can load or save.
    /// </summary>
    public abstract class FileType
    {
        ...
        protected unsafe Bitmap CreateAliased32BppBitmap(Surface surface)
        {
            int stride = surface.Width * 4;
            int realStride = ((stride + 3) / 4) * 4; // round up to multiple of 4
            return new Bitmap(surface.Width, surface.Height, realStride, PixelFormat.Format32bppArgb   , new IntPtr(surface.Scan0.VoidStar));
        }
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// If a FileType is asked to save a Document that has more than one blayer,
        ...
        */
            ...
            bool rememberToken)
        {
            ...
            else
            {
                ...
                {
                    scratchSurface = new Surface(input.Size, new ColorBgra());
       ...
       /* [Obsolete("Use the other OnSave() overload. It provides a scratch rendering RGB32_Surface that may enable your plugin to conserve memory usage.")]
