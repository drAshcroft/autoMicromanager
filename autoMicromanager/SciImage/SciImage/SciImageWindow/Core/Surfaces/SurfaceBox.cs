...
namespace SciImage
{
        ...
        : Control
    {
        ...
        {
            dst.Clear(dst.ColorPixelBase.TransparentColor());
        ...
        /// of the blank document's blayer.
        /// </summary>
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            // maintain the aspect ratio of the RGB32_Surface. Keeping the mouse
        ...
        private Surface GetDoubleBuffer(Size size)
        {
            ...
            // If we already have a double buffer RGB32_Surface reference, but if that RGB32_Surface
            ...
            // Make sure the RGB32_Surface is big enough.
            ...
            // So, do we have a RGB32_Surface? If not then we'd better make one.
            if (localDBSurface == null)
            {
                Size newSize = new Size(Math.Max(size.Width, oldSize.Width), Math.Max(size.Height, oldSize.Height));
                localDBSurface = new Surface(newSize.Width, newSize.Height,new ColorBgra());
        ...
        /// </summary>
        /// <param name="ra">The rendering RGB32_Surface object to draw to.</param>
        /// <param name="offset">The virtual offset of ra, in client (destination) coordinates.</param>
        /// <remarks>
        /// If drawing to ra.Surface or ra.Bitmap, copy the roi of the source RGB32_Surface to (0,0) of ra.Surface or ra.Bitmap
        /// If drawing to ra.Graphics, copy the roi of the RGB32_Surface to (roi.X, roi.Y) of ra.Graphics
        /// </remarks>
        private unsafe void DrawArea(RenderArgs ra, Point offset)
        {
            ...
            for (int i = 0; i < renderContext.windows.Length; ++i)
            {
                if (renderContext.windows[i] != null)
                {
                    ...
                    //renderContext.waitCallback(BoxedConstants.GetInt32(i));
                }
            }
        ...
        /// <summary>
        /// Converts from control client coordinates to RGB32_Surface coordinates
        /// This is useful when this.Bounds != RGB32_Surface.Bounds (i.e. some sort of zooming is in effect)
        /// </summary>
