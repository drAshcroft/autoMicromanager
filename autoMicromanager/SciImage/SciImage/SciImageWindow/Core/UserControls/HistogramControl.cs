...
namespace SciImage
{
        ...
        : UserControl
    {
        ...
        private void RenderChannel(Graphics g, ColorPixelBase color, int channel, long max, float mean)
        {
            ...
            ColorPixelBase colorPen = color.Blend(color.BlackColor(), color, intensity);
            ColorPixelBase colorBrush = color;

            colorBrush.alpha  = intensity;
