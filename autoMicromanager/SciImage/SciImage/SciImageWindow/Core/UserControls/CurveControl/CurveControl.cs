...
namespace SciImage
{
        ...
        : UserControl
    {
        ...
        protected ColorPixelBase[] visualColors;
        public ColorPixelBase GetVisualColor(int channel)
        {
        ...
        protected CurveControl(int channels, int entries)
        {
        ...
        private void DrawToGraphics(Graphics g, ColorPixelBase RequiredFormat)
        {
            ColorPixelBase colorSolid = RequiredFormat.FromColor(this.ForeColor);
            ColorPixelBase colorGuide = RequiredFormat.FromColor(this.ForeColor);
            ColorPixelBase colorGrid = RequiredFormat.FromColor(this.ForeColor);
            ...
            for (int c = 0; c < channels; ++c)
            {
                ...
                ColorPixelBase color = GetVisualColor(c);
                ColorPixelBase colorSelected = color.Blend(color, color.WhiteColor(), 128);
        ...
        {
            DrawToGraphics(e.Graphics,new ColorBgra());
            base.OnPaint(e);
        }
