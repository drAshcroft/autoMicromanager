...
namespace SciImage
{
    public sealed class SwatchControl
        : Control
    {
        private List<ColorPixelBase> colors = new List<ColorPixelBase>();
        ...
        public ColorPixelBase[] Colors
        {
            ...
            set
            {
                this.colors = new List<ColorPixelBase>(value);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                ColorPixelBase c = this.colors[i];
