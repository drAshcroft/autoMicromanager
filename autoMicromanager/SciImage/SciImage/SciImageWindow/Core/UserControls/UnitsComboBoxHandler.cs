...
namespace SciImage
{
        ...
        : IUnitsComboBox
    {
        ...
        private void ReloadItems()
        {
            ...
            string pixelsString = "Pixel";
            string inchesString = "Inch";
            string centimetersString = "Centimeter";

            if (pixelsString == "") pixelsString = "Pixels";
            if (inchesString == "") inchesString = "Inches";
            if (centimetersString == "") centimetersString = "Centimeters";
            if (lowercase)
            {
