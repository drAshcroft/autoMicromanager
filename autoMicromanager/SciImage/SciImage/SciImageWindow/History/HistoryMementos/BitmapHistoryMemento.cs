...
namespace SciImage.HistoryMementos
{
        ...
        : HistoryMemento
    {
        ...
        private static unsafe void LoadOrSaveSurfaceRegion(FileStream fileHandle, Surface surface, PdnRegion region, bool trueForSave)
        {
            ...
            long length = (long)regionBounds.Width * (long)regionBounds.Height * (long)surface.ColorPixelBase.SizeOf;
                ...
                surface.IsContiguousMemoryRegion(regionBounds))
            {
                ...
                ppvBuffers[0] = surface.hGetPointAddressUnchecked(regionBounds.Location);
            ...
            else
            {
                ...
                for (int i = 0; i < scans.Length; ++i)
                {
                    ...
                    if (rect.Width != 0 && rect.Height != 0)
                    {
                        ...
                        {
                            ppvBuffers[scanIndex] = surface.hGetPointAddressUnchecked(new Point(rect.Left, y));
                            lengths[scanIndex] = (uint)(rect.Width * surface.ColorPixelBase .SizeOf);
                            ++scanIndex;
                        }
                    }
                }
        ...
        public BitmapHistoryMemento(string name, ImageResource image, IHistoryWorkspace historyWorkspace, 
            ...
            : this(name, image, historyWorkspace, layerIndex, changedRegion,
                   ((Layer)historyWorkspace.Document.Layers[layerIndex]).Surface)
        {
        }
