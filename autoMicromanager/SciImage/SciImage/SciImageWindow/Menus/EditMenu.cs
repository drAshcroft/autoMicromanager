...
namespace SciImage.Menus
{
        ...
        : PdnMenuItem
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "Menu.Edit";
            this.Text = "Edit";//PdnResources.GetString("Menu.Edit.Text");
            // 
            // menuEditUndo
            // 
            ...
            this.menuEditFillSelection.ShortcutKeyDisplayString = "FillSelection";// PdnResources.GetString("Menu.Edit.FillSelection.ShortcutKeysDisplayString");
        ...
        private void MenuEditCopy_Click(object sender, System.EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null)
            {
                new CopyToClipboardAction().PerformAction(AppWorkspace, null, -1);
            }
        }
        ...
        private void MenuEditCut_Click(object sender, System.EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null)
            {
                ...
                cutAction.PerformAction(AppWorkspace, null, -1);
            }
        }
        ...
        private void MenuEditInvertSelection_Click(object sender, System.EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null &&
                !AppWorkspace.ActiveDocumentWorkspace.Selection.IsEmpty)
            {
                //HistoryFunctionResult result = AppWorkspace.ActiveDocumentWorkspace.ExecuteFunction(new InvertSelectionAction());
                bool result= AppWorkspace.ActiveDocumentWorkspace.PerformAction(new InvertSelectionAction());
        ...
        private void MenuEditClearSelection_Click(object sender, System.EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null)
            {
                AppWorkspace.ActiveDocumentWorkspace.PerformAction (new EraseSelectionAction());
            }
        }
        ...
        private void MenuEditFillSelection_Click(object sender, EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null)
            {
                AppWorkspace.ActiveDocumentWorkspace.PerformAction(new FillSelectionAction());
            }
        }
        ...
        private void MenuEditSelectAll_Click(object sender, System.EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null)
            {
                AppWorkspace.ActiveDocumentWorkspace.PerformAction  (new SelectAllAction());
        ...
        private void MenuEditDeselect_Click(object sender, System.EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null)
            {
                AppWorkspace.ActiveDocumentWorkspace.PerformAction(new DeselectAction());
            }
        }
        ...
        private void MenuEditPaste_Click(object sender, System.EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null)
            {
                new PasteAction().PerformAction(AppWorkspace, null, -1);
            }
        }
        ...
        private void MenuEditPasteInToNewLayer_Click(object sender, System.EventArgs e)
        {
            if (AppWorkspace.ActiveDocumentWorkspace != null)
            {
                new PasteInToNewLayerAction().PerformAction(AppWorkspace, null, -1);
            }
        }
