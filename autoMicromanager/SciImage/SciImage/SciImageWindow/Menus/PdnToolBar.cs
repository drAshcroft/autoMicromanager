...
namespace SciImage
{
          ...
          IPaintBackground
    {
        ...
        public PdnToolBar()
        {
            ...
            InitializeComponent();
            IllegalInitializeComponent();
            //try
            {
                ToolInfo[] Tools = DocumentWorkspace.ToolInfos;
                this.toolChooserStrip.SetTools(Tools);
            }
            //catch (Exception ex)
            {
            }
        ...
        private void InitializeComponent()
        {
            ...
            //this.toolStripPanel.Controls.Clear();
            ...
            this.viewConfigStrip.ZoomBasis = SciImage.ZoomBasis.FitToWindow;
            ...
            this.toolConfigStrip.ShapeDrawType = SciImage.ShapeDrawType.Outline;
        ...
        private void IllegalInitializeComponent()
        {
