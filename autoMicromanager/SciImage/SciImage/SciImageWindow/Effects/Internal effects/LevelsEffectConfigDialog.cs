...
namespace SciImage.Effects
{
        ...
        : EffectConfigDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            SciImage.HistogramRgb histogramRgb1 = new SciImage.HistogramRgb();
            SciImage.HistogramRgb histogramRgb2 = new SciImage.HistogramRgb();
            ...
            this.headerHistogramOutput = new SciImage.HeaderLabel();
            this.headerControlsOutput = new SciImage.HeaderLabel();
            this.headerControlsInput = new SciImage.HeaderLabel();
            this.headerHistogramInput = new SciImage.HeaderLabel();
            ...
            this.gradientInput = new SciImage.ColorGradientControl();
            this.swatchOutMid = new System.Windows.Forms.Panel();
            this.gradientOutput = new SciImage.ColorGradientControl();
            this.tableLayoutPanel2 = new System.Windows.Forms.TableLayoutPanel();
            this.histogramInput = new SciImage.HistogramControl();
            this.histogramOutput = new SciImage.HistogramControl();
            ...
            this.gradientInput.ValueChanged += new SciImage.IndexEventHandler(this.gradientInput_ValueChanged);
            ...
            this.gradientOutput.ValueChanged += new SciImage.IndexEventHandler(this.gradientOutput_ValueChanged);
