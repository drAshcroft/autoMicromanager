...
namespace SciImage.SystemLayer
{
    /// <summary>
    ...
    public unsafe static class Memory
    {
        ...
        /// </remarks>
        public static IntPtr AllocateBitmap(int width, int height, int PixelWidthBPP, out IntPtr handle)
        {
            ...
            bmi.bmiHeader.biBitCount = (ushort)PixelWidthBPP ;
            ...
            handle = hBitmap;
            long bytes = (long)width * (long)height * (long)(PixelWidthBPP/8);
        ...
        public static void FreeBitmap(IntPtr handle, int width, int height, int PixelWidthBPP)
        {
            long bytes = (long)width * (long)height * PixelWidthBPP ;
