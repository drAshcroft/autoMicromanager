...
namespace SciImage.SystemLayer
{
    ...
    public static class NativeInterfaces
    {
        ...
        public interface IStream
            : ISequentialStream
        {
            // Defined on ISequentialStream - repeated here due to requirements of COM interop blayer
            [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        ...
        {
            // Defined on IModalWindow - repeated here due to requirements of COM interop blayer
            // --------------------------------------------------------------------------------
            [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime), PreserveSig]
        ...
        public interface IFileOpenDialog : IFileDialog
        {
            ...
            // Defined on IFileDialog - repeated here due to requirements of COM interop blayer
            [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
