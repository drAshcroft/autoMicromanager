...
namespace SciImage
{
          ...
          ISelectionDrawModeConfig
    {
        ...
        private EnumLocalizer lineCapLocalizer = EnumLocalizer.Create(typeof(SciImage.PenInfo.LineCap2));
        ...
        private EnumLocalizer colorPickerBehaviorNames = EnumLocalizer.Create(typeof(SciImage.ColorPickers.ColorPickerClickBehavior));
        ...
        private SciImage.PenInfo.LineCap2[] lineCaps =
            new SciImage.PenInfo.LineCap2[]
            {
                SciImage.PenInfo.LineCap2.Flat,
                SciImage.PenInfo.LineCap2.Arrow,
                SciImage.PenInfo.LineCap2.ArrowFilled,
                SciImage.PenInfo.LineCap2.Rounded
            };
        ...
        public ToolConfigStrip()
        {
            ...
            this.solidBrushText = "Solid Color"; // "Solid Brush"
            ...
            this.penSizeDecButton.ToolTipText = "Smaller Brush:";
            this.penSizeDecButton.Image = PdnResources.GetImageResource("Icons.MinusButtonIcon.png").Reference;
            this.penSizeIncButton.ToolTipText = "Larger Brush:";
            ...
            this.penStartCapSplitButton.ToolTipText = "Change Line Start Shape";
            ...
            this.penDashStyleSplitButton.ToolTipText = "Change Dash Style of Line";
            ...
            this.penEndCapSplitButton.ToolTipText = "Change Line End Shape";
            ...
            this.fontBoldButton.ToolTipText = "Bold";
            this.fontItalicsButton.ToolTipText = "Italics";
            this.fontUnderlineButton.ToolTipText = "Underline";
            this.fontAlignLeftButton.ToolTipText = "Align Left";
            this.fontAlignCenterButton.ToolTipText = "Center Align";
            this.fontAlignRightButton.ToolTipText = "Align Right";
            ...
            this.resamplingLabel.Text = "Resampling Quality";
            ...
            this.colorPickerLabel.Text = "After Click Action";
            ...
            Array.Sort<string>(
                ...
                {
                    SciImage.ColorPickers.ColorPickerClickBehavior lhsE = (SciImage.ColorPickers.ColorPickerClickBehavior)this.colorPickerBehaviorNames.LocalizedNameToEnumValue(lhs);
                    SciImage.ColorPickers.ColorPickerClickBehavior rhsE = (SciImage.ColorPickers.ColorPickerClickBehavior)this.colorPickerBehaviorNames.LocalizedNameToEnumValue(rhs);
            ...
            this.selectionCombineModeLabel.Text = "Selection Mode:";

            this.floodModeLabel.Text = "Flood Fill Mode:";

            this.selectionDrawModeModeLabel.Text = "Draw mode:";
            this.selectionDrawModeWidthLabel.Text = "Line Width";
            this.selectionDrawModeHeightLabel.Text = "Line Height";
        ...
        private SciImage.PenInfo.LineCap2 NextLineCap(SciImage.PenInfo.LineCap2 oldCap)
        {
            int capIndex = Array.IndexOf<SciImage.PenInfo.LineCap2>(this.lineCaps, oldCap);
        ...
        public PenInfo PenInfo
        {
            get
            {
                ...
                SciImage.PenInfo.LineCap2 startCap;

                try
                {
                    startCap = (SciImage.PenInfo.LineCap2)this.penStartCapSplitButton.Tag;
                }
                ...
                SciImage.PenInfo.LineCap2 endCap;

                try
                {
                    endCap = (SciImage.PenInfo.LineCap2)this.penEndCapSplitButton.Tag;
                }
        ...
        private ImageResource GetLineCapImage(SciImage.PenInfo.LineCap2 lineCap, bool isStartCap)
        {
        ...
        private void PenCapSplitButton_DropDownOpening(object sender, EventArgs e)
        {
            ...
            SciImage.PenInfo.LineCap2 currentLineCap = PenInfo.DefaultLineCap;
            bool isStartCap;
            ...
            foreach (SciImage.PenInfo.LineCap2 lineCap in this.lineCaps)
            {
                ToolStripMenuItem mi = new ToolStripMenuItem(
                    ...
                    {
                        ToolStripMenuItem tsmi = (ToolStripMenuItem)sender2;
                        Pair<ToolStripSplitButton, SciImage.PenInfo.LineCap2> data = (Pair<ToolStripSplitButton, SciImage.PenInfo.LineCap2>)tsmi.Tag;
        ...
        private void FontFamilyComboBox_DrawItem(object sender, System.Windows.Forms.DrawItemEventArgs e)
        {
            if (e.Index != -1)
            {
                ...
                using (Font myFont = IndexToFont(e.Index, 10, FontStyle.Regular))
                {
                    ...
                    bool isSymbol = SciImage.SystemLayer.Fonts.IsSymbolFont(myFont);
        ...
        public SciImage.ColorPickers.ColorPickerClickBehavior ColorPickerClickBehavior
        {
            get
            {
                string selectedItem = (string)this.colorPickerComboBox.SelectedItem;
                SciImage.ColorPickers.ColorPickerClickBehavior cpcb = (SciImage.ColorPickers.ColorPickerClickBehavior)this.colorPickerBehaviorNames.LocalizedNameToEnumValue(selectedItem);
                return cpcb;
            }
