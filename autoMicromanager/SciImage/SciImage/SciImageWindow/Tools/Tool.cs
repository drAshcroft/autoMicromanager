...
namespace SciImage
{
    ...
    public class Tool
        : IDisposable,
          IHotKeyTarget
    {
        public static readonly Type DefaultToolType = typeof(Tools.PencilTool );
        ...
        protected Surface ScratchSurface
        {
            get
            {
                ...
                {
                    scratchSurface.Clear();//(  .FromBgra(64, 128, 192, 128));
        ...
        {
            System.Diagnostics.Debug.Print("REsoreregion");
            if (region != null)
            {
        ...
        public void RestoreSavedRegion()
        {
            if (this.saveRegion != null)
            {
                System.Diagnostics.Debug.Print("REstoresavedregion");
                Layer activeLayer = (Layer)ActiveLayer;
        ...
        public void SaveRegion(PdnRegion saveMeRegion, Rectangle saveMeBounds,ColorPixelBase  RequiredFormat)
        {
            System.Diagnostics.Debug.Print("SaveRegion");
            Layer activeLayer = (Layer)ActiveLayer;
        ...
        private void Activate()
        {
            ...
            this.trackingNub.Shape = SciImage.MoveNubRenderer.MoveNubShape.Compass;
                        ...
                        switch (e.KeyChar)
                        {
                            ...
                            case (char)27: // Escape
                                if (this.mouseDown == 0 && !Selection.IsEmpty)
                                {
                                    ...
                                    documentWorkspace.PerformAction(new DeselectAction());
                                }
