...
namespace SciImage.Tools
{
        ...
        : MoveToolBase
    {
        public static string StaticName
        {
            get
            {
                return "Move and Manipulate Selected Pixels , Use right mouse button for rotation.";
            }
        }
            ...
            : ToolHistoryMemento
        {
            ...
            protected override HistoryMemento OnToolUndo()
            {
                ...
                if (moveTool.ActiveLayerIndex != this.layerIndex)
                {
                    ...
                    moveTool.activeLayer = (Layer)moveTool.ActiveLayer;
        ...
        {
            System.Diagnostics.Debug.Print("OnActivate");
            ...
            this.activeLayer = (Layer)ActiveLayer;
        ...
        {
            /*
            System.Diagnostics.Debug.Print("Drop");
            RestoreSavedRegion();
        ...
        protected override void OnLift(MouseEventArgs e)
        {
            ...
            {
                ColorPixelBase fill = AppEnvironment.SecondaryColor;
                fill.alpha  = 0;
        ...
        protected void Render(Point newOffset, bool useNewOffset, bool saveRegion)
        {
            ...
            if (saveRegion)
            {
                SaveRegion(simplifiedRegion, saveBounds,activeLayer.Surface.ColorPixelBase );
            }
            ...
            if (this.activeLayer.GetType () == typeof (BitmapLayer ))
            {
        ...
        {
            System.Diagnostics.Debug.Print("OnMouseUp");
        ...
        public MoveTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   ...
                   MoveTool.StaticName,
                   "Drag to move, Right mouse to Rotate", // "Click and drag to move a selected region",
                   'm',
                   false,
