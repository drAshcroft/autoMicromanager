        ...
        : Tool
    {
        ...
        protected void PositionNubs(Mode currentMode)
        {
            if (this.moveNubs == null)
            {
                ...
                this.moveNubs[(int)Edge.TopLeft].Shape = SciImage.MoveNubRenderer.MoveNubShape.Circle;
                ...
                this.moveNubs[(int)Edge.TopRight].Shape = SciImage.MoveNubRenderer.MoveNubShape.Circle;
                ...
                this.moveNubs[(int)Edge.BottomLeft].Shape = SciImage.MoveNubRenderer.MoveNubShape.Circle;
                ...
                this.moveNubs[(int)Edge.BottomRight].Shape = SciImage.MoveNubRenderer.MoveNubShape.Circle;
            }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (Selection.IsEmpty)
            {
                SelectionHistoryMemento shm = new SelectionHistoryMemento(
                    Actions.SelectAllAction.StaticName,
