...
namespace SciImage.Tools
{
        ...
        : Tool 
    {
        ...
        private void DrawPoint(RenderArgs ra, Point p, ColorPixelBase color)
        {
        ...
        private void DrawLines(RenderArgs ra, List<Point> points, int startIndex, int length, ColorPixelBase color)
        {
