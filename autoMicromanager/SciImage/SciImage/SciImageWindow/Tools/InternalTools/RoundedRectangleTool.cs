...
namespace SciImage.Tools
{
        ...
        : ShapeTool 
    {
        ...
        private string statusTextFormat = "Boundery size: {0}{1} x {2}{3}, Covered area: {4} {5} in pixels";
        ...
        protected override PdnGraphicsPath CreateShapePath(PointF[] points)
        {
            ...
            {
                string unitsAbbreviationName =MeasurementUnitDetails.Abbreviation( units);
            ...
            string unitsString = MeasurementUnitDetails.Plural(units);
        ...
        public RoundedRectangleTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   ...
                   "Rounded Rectangle",
                   "Use shift for force the tool to draw a square")
        {
        }
