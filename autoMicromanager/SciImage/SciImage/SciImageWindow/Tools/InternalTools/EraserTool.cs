        ...
        : Tool
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (mouseDown && ((e.Button & mouseButton) != MouseButtons.None))
            {
                ...
                {
                    alpha = AppEnvironment.PrimaryColor.alpha ;
                }
                else
                {
                    alpha = AppEnvironment.SecondaryColor.alpha ;
                }
                ...
                if (saveRect.Width > 0 && saveRect.Height > 0 && renderArgs.Graphics.IsVisible(saveRect))
                {
                    ...
                    BinaryPixelOp bo= new BinaryPixelOps.SetColorChannels();
                    
                    bo.Apply(renderArgs.Surface, saveRect.Location, 
        ...
        public EraserTool(DocumentWorkspace documentWorkspace) 
            : base(documentWorkspace,
                   ...
                   "Rub out tool",
                   "Click to remove drawing", //"Click and drag to erase a portion of the image",
                   'e',
                   false,
