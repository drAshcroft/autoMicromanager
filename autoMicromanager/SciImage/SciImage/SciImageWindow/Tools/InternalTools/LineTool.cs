...
namespace SciImage.Tools
{
        ...
        : ShapeTool 
    {
        ...
        private string statusTextFormat = "Origin at: {0}{1} x {2}{3}, Length of: {4} {5}, Angle with horizon: {6}°";
        ...
        protected override PdnGraphicsPath CreateShapePath(PointF[] points)
        {
            ...
            else //if (points.Length <= 2)
            {
                ...
                {
                    string unitsAbbreviationName = MeasurementUnitDetails.Plural ( units);
