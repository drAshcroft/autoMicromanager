...
namespace SciImage.Tools
{
        ...
        : Tool
    {
        ...
        protected override void OnActivate()
        {
            ...
            // creates a bitmap blayer from the active blayer
        ...
        protected void RenderShape()
        {
            ...
            ColorPixelBase primary = AppEnvironment.PrimaryColor;
            ColorPixelBase secondary = AppEnvironment.SecondaryColor;
            ...
            if (shapePath != null)
            {
                ...
                SaveRegion(invalidOutlineRegion, invalidOutlineRegion.GetBoundsInt(),renderArgs.Surface.ColorPixelBase );
                ...
                {
                    SaveRegion(invalidInteriorRegion, invalidInteriorRegion.GetBoundsInt(),renderArgs.Surface.ColorPixelBase );
