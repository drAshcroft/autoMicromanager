...
namespace Micromanager_net.NI_Controls
{
    ...
    public partial class AllDeviceHolders : UserControl, IAllDeviceHolders 
    {
        ...
        public void DisplayGUIs(NI_BaseControl baseControl)
        {
            
            List<UserControl > GUIS=  baseControl.GetAllLoadedDeviceGUIs();
        ...
        private void AddTabPage(UserControl NewControl)
        {
            ...
            try
            {
                string Caption = ((Micromanager_net.UI.GUIDeviceControl)NewControl).Caption();
    ...
    {
        void DisplayGUIs(NI_BaseControl baseControl);
    }
}
