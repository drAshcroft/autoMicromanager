...
{
    public delegate void OnDoubleScrollEvent(object sender,int index,ScrollEventArgs e);
    /// <summary>
    ...
    {
        private bool[]  CaptureMouse=new bool[2];
        #region Events
        ...
        private Rectangle[] thumbRect=new Rectangle[2]; //bounding rectangle of thumb area
        /// <summary>
        /// Gets the thumb rect. Usefull to determine bounding rectangle when creating custom thumb shape.
        /// </summary>
        /// <value>The thumb rect.</value>
        [Browsable(false)]
        public Rectangle ThumbRectLower
        {
            get { return thumbRect[0]; }
        }
        /// <summary>
        /// Gets the thumb rect. Usefull to determine bounding rectangle when creating custom thumb shape.
        /// </summary>
        /// <value>The thumb rect.</value>
        [Browsable(false)]
        public Rectangle ThumbRectUpper
        {
            get { return thumbRect[1]; }
        }

        private Rectangle barRect; //bounding rectangle of bar area
        private Rectangle barHalfRect;
        private Rectangle[] thumbHalfRect=new Rectangle[2];
        private Rectangle[] elapsedRect=new Rectangle [2]; //bounding rectangle of elapsed area
        ...
        private int trackerValueLower = 50;
        private int trackerValueUpper = 51;
        /// <summary>
        /// Gets or sets the Lower value of Slider.
        /// </summary>
        ...
        [Description("Set Slider Lower value")]
        [Category("ColorSlider")]
        [DefaultValue(50)]
        public int ValueLower
        {
            get { return trackerValueLower; }
            set
            {

                if (value > trackerValueUpper)
                {
                    trackerValueLower = trackerValueUpper ;
                }
                else if (value >= barMinimum & value <= barMaximum)
                {
                    trackerValueLower = value;
        ...
        {
            get { return trackerValueUpper; }
            set
            {

                if (value<trackerValueLower)
                {
                    trackerValueUpper= trackerValueLower ;
                }
                else if (value >= barMinimum & value <= barMaximum)
                {
                    trackerValueUpper = value;
                    if (ValueChanged != null) ValueChanged(this, new EventArgs());
                    Invalidate();
                }
                else throw new ArgumentOutOfRangeException("Value is outside appropriate range (min, max)");
        ...
        public int Minimum
        {
            ...
            set
            {
                ...
                {
                    barMinimum = value;
                    if (trackerValueLower < barMinimum)
                    {
                        trackerValueLower = barMinimum;
                        if (ValueChanged != null) ValueChanged(this, new EventArgs());
                    }
                    if (trackerValueUpper < barMinimum)
                    {
                        trackerValueUpper = barMinimum;
                        if (ValueChanged != null) ValueChanged(this, new EventArgs());
                    }
        ...
        public int Maximum
        {
            ...
            set
            {
                ...
                {
                    barMaximum = value;
                    if (trackerValueLower > barMaximum)
                    {
                        trackerValueLower = barMaximum;
                        if (ValueChanged != null) ValueChanged(this, new EventArgs());
                    }
                    if (trackerValueUpper > barMaximum)
                    {
                        trackerValueUpper = barMaximum;
                        if (ValueChanged != null) ValueChanged(this, new EventArgs());
                    }
                    Invalidate();
                }
        ...
        public DoubleSlider(int min, int max, int valueLower,int valueUpper)
        {
            InitializeComponent();
        ...
        /// Initializes a new instance of the <see cref="ColorSlider"/> class.
        /// </summary>
        public DoubleSlider() : this(0, 100, 25,75) { }
                                     ...
                                     Color barPenColorPaint, Color elapsedOuterColorPaint, Color elapsedInnerColorPaint)
        {
            try
            {
                ...
                {
                    int TrackX = (((trackerValueLower - barMinimum) * (ClientRectangle.Width - thumbSize)) / (barMaximum - barMinimum));
                    thumbRect[0] = new Rectangle(TrackX, 1, thumbSize - 1, ClientRectangle.Height - 3);
                    TrackX = (((trackerValueUpper - barMinimum) * (ClientRectangle.Width - thumbSize)) / (barMaximum - barMinimum));
                    thumbRect[1] = new Rectangle(TrackX, 1, thumbSize - 1, ClientRectangle.Height - 3);

                }
                else
                {
                    int TrackY = (((trackerValueLower - barMinimum) * (ClientRectangle.Height - thumbSize)) / (barMaximum - barMinimum));
                    thumbRect[0] = new Rectangle(1, TrackY, ClientRectangle.Width - 3, thumbSize - 1);

                    TrackY = (((trackerValueUpper - barMinimum) * (ClientRectangle.Height - thumbSize)) / (barMaximum - barMinimum));
                    thumbRect[1] = new Rectangle(1, TrackY, ClientRectangle.Width - 3, thumbSize - 1);
                }
                ...
                if (barOrientation == Orientation.Horizontal)
                {
                    ...
                    thumbHalfRect[0].Height /= 2;
                    thumbHalfRect[1].Height /= 2;
                    elapsedRect[0] = barRect;
                    elapsedRect[1] = barRect;

                    elapsedRect[0].Width = thumbRect[0].Left + thumbSize / 2;
                    elapsedRect[1].Width = barRect.Width - (thumbRect[1].Left + thumbSize / 2);
                    elapsedRect[1].X = thumbRect[1].Left + thumbSize / 2;
                }
                else
                {
                    ...
                    thumbHalfRect[0].Width /= 2;
                    thumbHalfRect[1].Width /= 2;
                    elapsedRect[0] = barRect;
                    elapsedRect[1] = barRect;

                    elapsedRect[0].Height = thumbRect[0].Top + thumbSize / 2;
                    elapsedRect[1].Height = barRect.Height - (thumbRect[1].Top + thumbSize / 2);
                    elapsedRect[1].Y = thumbRect[1].Top + thumbSize / 2;
                }
                //get thumb shape path 
                GraphicsPath[] thumbPath=new GraphicsPath[2];
                if (thumbCustomShape == null)
                {
                    thumbPath[0] = CreateRoundRectPath(thumbRect[0], thumbRoundRectSize);
                    thumbPath[1] = CreateRoundRectPath(thumbRect[1], thumbRoundRectSize);
                }
                else
                {
                    thumbPath[0] = thumbCustomShape;
                    Matrix m = new Matrix();
                    m.Translate(thumbRect[0].Left - thumbPath[0].GetBounds().Left, thumbRect[0].Top - thumbPath[0].GetBounds().Top);
                    thumbPath[0].Transform(m);

                    thumbPath[1] = thumbCustomShape;
                    m = new Matrix();
                    m.Translate(thumbRect[1].Left - thumbPath[1].GetBounds().Left, thumbRect[1].Top - thumbPath[1].GetBounds().Top);
                    thumbPath[1].Transform(m);
                    ...
                    )
                {
                                                    ...
                                                    gradientOrientation))
                    {
                        ...
                        if ((CaptureMouse[0] || CaptureMouse[1] ) && drawSemitransparentThumb)
                        {
                            Region elapsedReg = new Region(elapsedRect[0]);
                            elapsedReg.Exclude(thumbPath[0]);
                            
                            e.Graphics.FillRegion(lgbElapsed, elapsedReg);

                            elapsedReg = new Region(elapsedRect[1]);

                            elapsedReg.Exclude(thumbPath[1]);
                            e.Graphics.FillRegion(lgbElapsed, elapsedReg);
                        }
                        else
                        {
                            e.Graphics.FillRectangle(lgbElapsed, elapsedRect[0]);
                            e.Graphics.FillRectangle(lgbElapsed, elapsedRect[1]);
                        }
                    }
                    //draw bar band                    
                ...
                using (
                    LinearGradientBrush lgbThumb0 =  new LinearGradientBrush(thumbHalfRect[0], newthumbOuterColorPaint, newthumbInnerColorPaint,
                                                gradientOrientation))

                {
                    lgbThumb0.WrapMode = WrapMode.TileFlipXY;
                    e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
                    e.Graphics.FillPath(lgbThumb0, thumbPath[0]);
                    //draw thumb band
                    Color newThumbPenColor = thumbPenColorPaint;
                    if (mouseEffects && (CaptureMouse[0] || mouseInThumbRegion[0]))
                        newThumbPenColor = ControlPaint.Dark(newThumbPenColor);
                    using (Pen thumbPen = new Pen(newThumbPenColor))
                    {
                        e.Graphics.DrawPath(thumbPen, thumbPath[0]);
                    }
                    //gp.Dispose();                    
                ...
                using (
                   LinearGradientBrush lgbThumb1= new LinearGradientBrush(thumbHalfRect[0], newthumbOuterColorPaint, newthumbInnerColorPaint,
                                               gradientOrientation))
                {
                    lgbThumb1.WrapMode = WrapMode.TileFlipXY;
                    e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
                    e.Graphics.FillPath(lgbThumb1, thumbPath[1]);
                    //draw thumb band
                    Color newThumbPenColor = thumbPenColorPaint;
                    if (mouseEffects && (CaptureMouse[1] || mouseInThumbRegion[1]))
                        newThumbPenColor = ControlPaint.Dark(newThumbPenColor);
                    using (Pen thumbPen = new Pen(newThumbPenColor))
                    {
                        e.Graphics.DrawPath(thumbPen, thumbPath[1]);
                    }
                    //gp.Dispose();                    
                    /*if (Capture || mouseInThumbRegion)
                        using (LinearGradientBrush lgbThumb2 = new LinearGradientBrush(thumbHalfRect, Color.FromArgb(150, Color.Blue), Color.Transparent, gradientOrientation))
        ...
        protected override void OnMouseLeave(EventArgs e)
        {
            base.OnMouseLeave(e);
            mouseInRegion = false;
            mouseInThumbRegion[0] = false;
            mouseInThumbRegion[1] = false;
            Invalidate();
        }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                mouseInThumbRegion[1] = IsPointInRect(e.Location, thumbRect[1]);
                CaptureMouse[1] = mouseInThumbRegion[1];
                if (mouseInThumbRegion[1]) if (Scroll != null) Scroll(this, 1, new ScrollEventArgs(ScrollEventType.ThumbTrack, trackerValueUpper));
                
                if (!CaptureMouse[1])
                {
                    mouseInThumbRegion[0] = IsPointInRect(e.Location, thumbRect[0]);
                    CaptureMouse[0] = mouseInThumbRegion[0];
                    if (mouseInThumbRegion[0]) if (Scroll != null) Scroll(this, 0, new ScrollEventArgs(ScrollEventType.ThumbTrack, trackerValueLower));
        ...
        private bool [] mouseInThumbRegion = new bool[2];// false;
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            base.OnMouseMove(e);
            mouseInThumbRegion[0] = IsPointInRect(e.Location, thumbRect[0]);
            if (CaptureMouse[0] & e.Button == MouseButtons.Left )
            {
                ...
                float coef = (float)(barMaximum - barMinimum) /
                             ...
                             ((barOrientation == Orientation.Horizontal ? ClientSize.Width : ClientSize.Height) -
                              2 * margin);
                trackerValueLower = (int)(p * coef + barMinimum);
                if (trackerValueLower > trackerValueUpper) trackerValueLower = trackerValueUpper;
                if (trackerValueLower <= barMinimum)
                {
                    trackerValueLower = barMinimum;
                    set = ScrollEventType.First;
                }
                else if (trackerValueLower >= barMaximum)
                {
                    trackerValueLower = barMaximum;
                    set = ScrollEventType.Last;
                }

                if (Scroll != null) Scroll(this,0, new ScrollEventArgs(set, trackerValueLower));
                if (ValueChanged != null) ValueChanged(this, new EventArgs());
            }

            mouseInThumbRegion[1] = IsPointInRect(e.Location, thumbRect[1]);
            if (CaptureMouse[1] & e.Button == MouseButtons.Left )
            {
                ScrollEventType set = ScrollEventType.ThumbPosition;
                Point pt = e.Location;
                int p = barOrientation == Orientation.Horizontal ? pt.X : pt.Y;
                ...
                float coef = (float)(barMaximum - barMinimum) /
                             ...
                             ((barOrientation == Orientation.Horizontal ? ClientSize.Width : ClientSize.Height) -
                              2 * margin);
                trackerValueUpper = (int)(p * coef + barMinimum);
                if (trackerValueUpper < trackerValueLower) trackerValueUpper = trackerValueLower;
                if (trackerValueUpper <= barMinimum)
                {
                    trackerValueUpper = barMinimum;
                    set = ScrollEventType.First;
                }
                else if (trackerValueUpper >= barMaximum)
                {
                    trackerValueUpper = barMaximum;
                    set = ScrollEventType.Last;
                }

                if (Scroll != null) Scroll(this,1, new ScrollEventArgs(set, trackerValueUpper));
                if (ValueChanged != null) ValueChanged(this, new EventArgs());
            }
            Invalidate();
        }
        ...
        {
            base.OnMouseUp(e);
            CaptureMouse[0] = false;
            CaptureMouse[1] = false;
            mouseInThumbRegion[0] = IsPointInRect(e.Location, thumbRect[0]);
            mouseInThumbRegion[1] = IsPointInRect(e.Location, thumbRect[1]);
            if (mouseInThumbRegion[0]) if (Scroll != null) Scroll(this,0, new ScrollEventArgs(ScrollEventType.EndScroll, trackerValueLower));
            if (mouseInThumbRegion[1]) if (Scroll != null) Scroll(this, 1, new ScrollEventArgs(ScrollEventType.EndScroll, trackerValueUpper));
            if (ValueChanged != null) ValueChanged(this, new EventArgs());
        ...
        protected override void OnKeyUp(KeyEventArgs e)
        {
            ...
            switch (e.KeyCode)
            {
                ...
                case Keys.Home:
                    ValueLower = (int)((barMaximum + barMinimum) / 2);
                    ValueUpper = (int)((barMaximum + barMinimum) / 2);
                    
                    break;
                case Keys.End:
                    ValueLower = barMinimum;
                    ValueUpper = barMaximum;
                    break;
                case Keys.PageDown:
        ...
        private void SetProperValue(int index, int val)
        {
            if (index == 0)
            {
                if (val < barMinimum) ValueLower = barMinimum;
                else if (val > barMaximum) ValueLower = barMaximum;
                else ValueLower = val;
            }
            else
            {
                if (val < barMinimum) ValueUpper = barMinimum;
                else if (val > barMaximum) ValueUpper = barMaximum;
                else ValueUpper = val;
            }
        }
