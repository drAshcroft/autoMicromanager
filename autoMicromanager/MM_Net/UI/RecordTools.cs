...
{
    public partial class RecordTools : UserControl, UI.GUIDeviceControl 
    {
        ...
        {
            CoreDevices.ChannelGroup cg=new Micromanager_net.CoreDevices.ChannelGroup(ECore );
        ...
        {
            CoreDevices.CoreImage c=  ECore.MMCamera.SnapOneFrame(true );
            try
            {
        ...
        private void TakeStackB_Click(object sender, EventArgs e)
        {
            ...
            CoreDevices.XYStage xyStage =(CoreDevices.XYStage) ECore.GetDevice(TargetXYStageCB.Text );
            CoreDevices.ZStage zStage = (CoreDevices.ZStage)ECore.GetDevice(TargetZStageCB.Text);
