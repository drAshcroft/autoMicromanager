...
namespace Micromanager_net
{
    ...
    public interface _MMToolKitComService
    {
        ...
        void TestProc();
        [DispId(8)]
        CoreDevices.EasyCore GetEasyCore();
    }
    ...
    public partial class MMToolKitComService : UserControl, _MMToolKitComService 
    {
        ...
        #region "VB6 Methods"
            ...
            public void TestProc()
            {
                ...
                MessageBox.Show("TestProc");
            }
            public CoreDevices.EasyCore GetEasyCore()
            {
                return new CoreDevices.EasyCore();
            }
