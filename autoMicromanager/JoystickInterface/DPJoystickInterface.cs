...
namespace JoystickInterface
{
    ...
    /// </summary>
    internal class DPJoystickInterface
    {
        ...
        public DPJoystickInterface(IntPtr window_handle)
        {
            hWnd = window_handle;
            axisA = -1;
            axisB = -1;
        ...
        public string CurrentAcquiredJoystick
        {
            get { return CurrentJoystick; }
        }
