...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public delegate string GetExtraInfoStringCallback();
	...
	public class DockContentHandler : IDisposable, IDockDragSource
	{
        ...
        public DockContentHandler(Form form, GetPersistStringCallback getPersistStringCallback, GetExtraInfoStringCallback getExtraStringCallback)
        {
            if (!(form is IDockContent))
                throw new ArgumentException(Strings.DockContent_Constructor_InvalidForm, "form");
            ...
            m_form = form;
            m_getPersistStringCallback = getPersistStringCallback;
            mGetExtraInfoStringCallback = getExtraStringCallback;
        ...
        internal string ExtraInfo
        {
            get
            {
                return GetExtraInfoStringCallback == null ? "" : GetExtraInfoStringCallback();
                /*if (Form.GetType() == typeof(DockContent))
                {
                    return ((DockContent)Form).ExtraInformation;
                }
                else 
                   return ""; */
            }
        ...
        private GetExtraInfoStringCallback mGetExtraInfoStringCallback = null;
        public GetExtraInfoStringCallback GetExtraInfoStringCallback
        {
            get { return mGetExtraInfoStringCallback; }
            set { mGetExtraInfoStringCallback = value; }
        }
