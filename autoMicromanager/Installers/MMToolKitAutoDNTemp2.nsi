...
Section /o "Labview 8.0 Controls and Tutorials" Section3
 push $1
	...
	; Set Section Files and Shortcuts
	<%InsertFiles "$R1\menus\Controls\autoMicromanager\" "..\LabViewMMControls80\"%>
	<%InsertFiles "$R1\menus\Controls\DotNet & ActiveX\autoMicromanager\" "..\LabViewMMControls80\"%>
 ...
 Sec2End:	 
  ...
  CreateDirectory "$SMPROGRAMS\autoMicromanager\Labview"
	...
	<%InsertShortCuts "$SMPROGRAMS\autoMicromanager\Labview\" "$INSTDIR\" "..\LabViewMM80\*.txt"%>
...
Section "Matlab Tutorials" Section5
  ...
  CreateDirectory "$SMPROGRAMS\autoMicromanager\Matlab"
	...
	<%InsertShortCuts "$SMPROGRAMS\autoMicromanager\Matlab\" "$INSTDIR\Matlab\" "..\Matlab\*.txt"%>
	;CreateShortCut "$SMPROGRAMS\Micromanager.NET\Labview\Tutorial1.lnk" "$INSTDIR\Labview\Tutorial1.vi"
...
Section "Python 2.5.x Tutorials" Section6
  ...
  CreateDirectory "$SMPROGRAMS\autoMicromanager\Python"
	...
	<%InsertShortCuts "$SMPROGRAMS\autoMicromanager\Python\" "$INSTDIR\Python\" "..\python2.5-UCS2\*.txt"%>
	;CreateShortCut "$SMPROGRAMS\Micromanager.NET\Labview\Tutorial1.lnk" "$INSTDIR\Labview\Tutorial1.vi"
...
Section "Scilab Tutorials" Section8
  ...
  <%InsertFiles "$INSTDIR\Scilab\" "..\Scilab\"%>
	; Set Section Files and Shortcuts
	SetOverwrite off
  ...
  CreateDirectory "$SMPROGRAMS\autoMicromanager\Scilab"
	<%InsertShortCuts "$SMPROGRAMS\autoMicromanager\Scilab\" "$INSTDIR\Scilab\" "..\Scilab\*.*"%>
...
Section "(D)COM/VB Tutorials" Section7
  ...
  CreateDirectory "$SMPROGRAMS\autoMicromanager\COM-VB Tutorials"
	...
	<%InsertShortCuts "$SMPROGRAMS\autoMicromanager\COM-VB Tutorials\" "$INSTDIR\VB6\" "..\VB6MM\*.vbs"%>
