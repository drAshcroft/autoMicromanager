...
{
    public partial class R_ScriptModule : UserControl, CoreDevices.UI.GUIDeviceControl
    {
        ...
        public void SetCore(EasyCore Ecore, string DeviceName)
        {
            ...
            statConn.Init("R");
            //statConn.AddGraphicsDevice("Graph1",(StatConnectorCommonLib.ISGFX) axGraphicsDevice1.get());
        ...
        private void ExecuteCommand(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                s.Context.SetItem("R_Conn", ContextItem.Variable, statConn );
                s.Context.SetItem("CoreImage", ContextItem.Type, typeof(CoreImage));
                if (ic.InImage == null)
                {
